...
namespace UltraNuke.Barasingha.Roleing.API.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<PaginatedItems<RoleDTO>> Query(string name, int pageIndex, int pageSize)
        {
        ...
        [Route("all")]
        [HttpGet]
        public ActionResult<List<RoleDTO>> QueryAll()
        {
        ...
        /// <returns>角色</returns>
        [HttpGet("{id}")]
        public ActionResult<RoleDTO> Get(Guid id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<RoleDTO>> Create(CreateRoleCommand param)
        {
        ...
        /// <returns>角色对象</returns>
        [HttpPut("{id}")]
        public async Task<ActionResult<RoleDTO>> Update(Guid id, UpdateRoleCommand param)
        {
            param.Id = id;
            var ret = await mediator.Send(param);
            return CreatedAtAction(nameof(Get), new { id = ret.Id }, ret);
